...
// Custom types allow us to combine types into one type and use it in multiple places
// This can make code cleaner to read and easier to maintain

type MathString = number | string;
